...
<body>
 <div class="mianCont">
  <div class="top">
   <span>您好！欢迎来到17商城 请&nbsp;<a href="/st-web/jsp/login.jsp">[登录]</a>&nbsp;<a href="/st-web/jsp/reg.jsp">[注册]</a></span>
   <span class="topRight">
  ...
  <div class="positions">
   当前位置：<a href="/st-web/jsp/index.jsp">首页</a> &gt; <a href="#" class="posCur">帮助中心</a>
  </div><!--positions/-->
  <div class="cont">
   <div class="contLeft" id="contLeft">
    ...
    <dl class="helpNav">
      ...
      <dd><a href="#">17官网</a></dd>
      <dd><a href="/st-web/jsp/contact.jsp" class="helpCur">联系方式</a></dd>
      <dd><a href="/st-web/jsp/about.jsp">企业简介</a></dd>
    </dl><!--helpNav/-->
   </div><!--contLeft/-->
   <div class="contRight">
